<script setup>
import { resourceCategories } from '~/utils/resourcesData'
...
useHead(() => ({
  title: 'الموارد مفتوحة المصدر | مُناجاتك',
  meta: [
    { name: 'description', content: 'مكتبة الملحقات المفتوحة المصدر الخاصة بمشروع مُناجاتك من قواعد بيانات وخطوط وصور.' }
  ]
}))
</script>
  ...
  <section class="download-assets-page section">
    ...
    <div class="container relative z-10">
      ...
      <div class="categories-container">
        <div v-for="category in resourceCategories" :key="category.id" class="category-block">
          ...
          <div class="cards-grid">
            <div v-for="item in category.items" :key="item.id" class="asset-card card-glass group">
              ...
              <NuxtLink :to="`/resources/${item.id}`" class="download-btn">
